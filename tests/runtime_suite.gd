...
func _lighting_checks() -> void:
	...
	var cloud_motion = game.world.cloud_offset.distance_to(offset)
	check(cloud_motion>0.1 and cloud_motion<1.0,"Wind moves the shared cloud field gently in world metres")
