...
func run() -> void:
	...
	preferences.set_value("shared","forest_visibility",-5); check(preferences.shared.forest_visibility==0,"Aid preference clamps off")
	preferences.set_value("shared","forest_visibility",INF); check(preferences.shared.forest_visibility==0,"Nonfinite aid preference retains valid value")
	preferences.set_value("shared","forest_visibility",101); check(preferences.shared.forest_visibility==100,"Aid preference clamps maximum")
	preferences.set_value("shared","forest_visibility_size",-5); check(preferences.shared.forest_visibility_size==20,"Size clamps to small opening")
	preferences.set_value("shared","forest_visibility_size",INF); check(preferences.shared.forest_visibility_size==20,"Invalid size retains valid value")
	preferences.set_value("shared","forest_visibility_size",101); check(preferences.shared.forest_visibility_size==100,"Maximum size enables full-screen mode")
	preferences.set_value("shared","forest_visibility_size",50)
	...
	check(restored.shared.forest_visibility==100,"Aid preference roundtrips")
	check(restored.shared.forest_visibility_size==50,"Size persists separately from reach")
