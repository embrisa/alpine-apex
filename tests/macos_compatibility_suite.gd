...
func _initialize() -> void:
	...
	check(Settings.resolve_upscaler("auto",false,"metal")=="bilinear", "Auto upscaling resolves to spatial bilinear on stock Metal (FSR 2 measured about 15 ms per frame on M4)")
