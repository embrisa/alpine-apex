...
func run() -> void:
	...
	preload("res://tests/test_report.gd").write("res://examples/mountains/default-v11.apexmountain",recipe.share_text()+"\n")
	preload("res://tests/test_report.gd").write("res://artifacts/geology_v11/integration_contracts.json",JSON.stringify({"checks":checks,"failures":failures,"height_sha256":field.height_checksum,"obstacle_sha256":field.obstacle_checksum,"geology_sha256":field.geology.fingerprint(),"cache_load_ms":again.generation_ms},"\t"))
