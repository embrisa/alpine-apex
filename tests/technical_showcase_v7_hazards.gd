...
func run() -> void:
	...
	preload("res://tests/test_report.gd").write("res://artifacts/technical_showcase_v7/hazards.json",JSON.stringify({"checks":checks,"failures":failures,"results":results},"\t"))
