...
const SOURCE="res://art_source/animation/cascadeur_evaluation_20260910_r6/ready_compression_r6_animation.glb"
const SOURCE_SHA="8b25cba89e0f0977cf63d37c8c31080e0dbf8a7b786a15d55d5c60c1e00b5a57"
const Motion=preload("res://scripts/presentation/skier_full_motion.gd")
static func load_for(visual) -> Dictionary:
	assert(FileAccess.get_sha256(SOURCE)==SOURCE_SHA,"R6 source changed")
