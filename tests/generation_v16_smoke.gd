...
func _initialize() -> void:
	...
	print("V16_PARSE ",field.GENERATOR_VERSION," key=",Cache.cache_key(849205174))
	...
	print("V16_PACKED_POSE ",buffer)
	if buffer[3]!=1 or buffer[7]!=2 or buffer[11]!=3: quit(2); return
	print("V16_ESTIMATE ",Estimates.label(Estimates.estimate(849205174,settings)))
	quit()
