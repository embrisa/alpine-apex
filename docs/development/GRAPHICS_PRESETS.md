...
track-buffer checks are recorded in [INTERFACE_PERFORMANCE.md](../presentation/INTERFACE_PERFORMANCE.md);
...
[interface evidence](../presentation/INTERFACE_OVERHAUL.md) and
[native performance evidence](../presentation/INTERFACE_PERFORMANCE.md) for final metrics,
