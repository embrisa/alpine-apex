...
- [Ski physics](../gameplay/SKIER_PHYSICS.md) owns two-ski support, body forces, flight and
  input. [Current carving](../gameplay/ARCADE_CARVING_V20.md) coordinates yaw, bank, grip and
  pressure through actual support; no root-motion or racing-line attractor.
  [Auto tuck and contact v21](../gameplay/TUCK_CONTACT_V21.md) retains steering authority with
  forward held and absorbs small bumps through bounded passive suspension.
  [Skid steering v22](../gameplay/SKID_RESPONSE_V22.md) releases sustained equipment-yaw
  suppression while preserving ordinary carving and physical support.
  [Thick snow v24](../world/PLANTED_SNOW.md) adds load-limited embedded-ski resistance
...
- [Impact reserve](../gameplay/IMPACT_RECOVERY.md) absorbs clean slope-matched landings and
  groups rough contacts. Steering/body lean alone cannot cause balance deaths.
- [Full-curve motion](../presentation/STEEP_MOTION_GAMEPLAY.md) reads completed physical state;
  [anatomical fitting](../presentation/SKIER_ANATOMY.md) and rigid bindings remain constraints.
  The character has one final skeleton writer and no cosmetic force feedback.
- [Reviewed downhill poses](../presentation/DOWNHILL_POSE_REVIEW_R2.md) refine ready stance,
  ...
  [Small banks v26](../gameplay/SNOW_CRUSHING.md) yield beneath supported skis at speed,
  within local loose depth and a 30 cm cap; the 28 cm leg suspension is separate.
- [V14 snow](../world/PLANTED_SNOW.md) builds on [v13 placement](../world/ALPINE_V13.md),
  the [v12 landforms](../world/ALPINE_V12.md) and
  [mineral fitting](../world/GEOLOGY_V11.md). Terrain, contact, tracks, survey and crashes
  share the authoritative 4 m support surface. Local powder relief is cosmetic.
- [Arcade air v27](../gameplay/ARCADE_AIR_V27.md) adds bounded ordinary pitch, fast manual
  flips/spins and release braking, with recorded air-tilt intent in replay v5.
- [Grounded snow v28](../gameplay/GROUNDED_SNOW_V28.md) softens rebound, absorbs small banks
...
[Future social play and competition](../gameplay/ONLINE_COMPETITION.md) records the design
...
joint fitting does not feed back into it. See [ski physics](../gameplay/SKIER_PHYSICS.md).
...
[Jump controls](../gameplay/JUMP_CONTROL.md) own release-to-hop, ledge/buffer behavior and
...
explicit control. [Impact recovery](../gameplay/IMPACT_RECOVERY.md) groups rough contacts and
absorbs clean slope-matched landings automatically. Rock abrasion remains its own
[material-response contract](../gameplay/ROCK_TERRAIN.md). Steering/lean alone do not kill balance.
...
load and slip to model resistance. [Snow presentation](../world/SNOW.md) reads completed
per-ski response, while [powder relief](../world/POWDER_VOLUME.md) supplies cosmetic nearby
...
The [athletic skier animation layer](../presentation/SKIER_ANIMATION.md) consumes completed
...
Current races use schema **3** and [shared summit-return rules](../world/WILDERNESS.md).
...
[MOUNTAINS.md](../gameplay/MOUNTAINS.md#terrain-and-session-boundaries).
...
[snow formations and acceptance](../world/SNOW.md).
...
and passive snow resistance. [Powder volume](../world/POWDER_VOLUME.md) documents the
