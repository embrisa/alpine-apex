...
|---|---|
| Skiing | Model 28 [grounded snow](../gameplay/GROUNDED_SNOW_V28.md), retained [carving calibration](../gameplay/ARCADE_CARVING_V20.md), [auto tuck/contact](../gameplay/TUCK_CONTACT_V21.md), and [aerial control with direct-stick flips](../gameplay/ARCADE_AIR_V27.md). Player handling and controller feel remain open; subsystem reports retain their known fixture failures and coverage limits. |
| Mountain | [v15 Standard, seed 849205174](GENERATION_V15.md); retained [v13 density](../world/ALPINE_V13.md), [v12 landforms](../world/ALPINE_V12.md) and [geology fitting](../world/GEOLOGY_V11.md) share one 4 m support surface. |
| Routes | The historical [v13 survey](../world/ALPINE_V13.md) found branching paths; its pilot completed face 3 and crashed/stalled on the other faces. This does not establish v15 six-face coverage or player acceptance. |
...
| Performance | Historical shared-load v13 measurements and the [2026-09-10 v14/model-26 comparison](FPS_OPTIMIZATION.md#2026-09-10-measured-comparison) miss the full frame-time gate. Later [model-28 short routes](../gameplay/GROUNDED_SNOW_V28.md#rendered-evidence-and-performance) also miss the target; [v15 generation/cache and scene diagnostics](GENERATION_V15.md#measurements-and-acceptance) do not establish current complete-descent performance. |
| Presentation | [Camera profiles and slope following](../gameplay/CAMERA.md), [snow readability](../world/SNOW_READABILITY.md), [interface](../presentation/INTERFACE.md), animation and [skiing audio](../audio/SKIING_AUDIO.md) retain subsystem evidence. Continuous-motion comfort, listening and user skiing acceptance remain open. |
...
- [x] [Skiing/input evidence](../../backlog/archive/AA-20260911-153901-input-acceptance-evidence.md): [2026-09-11 audit](../gameplay/CONTROLLER_FEEDBACK.md#input-acceptance-audit-on-2026-09-11) passed 388 automated checks and inspected eight native laboratory captures. Real-device feel/vibration and full-mountain skiing remain open; the report includes the player checklist and a posture observation for follow-up.
...
- [ ] [Racing-loop audit](../../backlog/tasks/AA-20260911-153905-race-loop-acceptance-audit.md): refresh authoring, retries, splits, finish and ghost evidence in [races](../gameplay/RACES.md) and [the competitive loop](../gameplay/COMPETITIVE_LOOP.md), with test saves isolated.
