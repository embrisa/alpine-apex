...
Native wind synthesis in [WIND_DSP.md](../audio/WIND_DSP.md) and the modified Godot DX12
...
| Audio: [wind DSP](../audio/WIND_DSP.md), [skiing audio](../audio/SKIING_AUDIO.md) | Keep costly sample processing in native audio callbacks; use bounded state exchange from gameplay | Callback cost, lifecycle correctness and actual listening/device acceptance |
