...
model 26 contact rules remain in place alongside [arcade air control](../gameplay/ARCADE_AIR_V27.md).
...
See [v15 generation and richness](../development/GENERATION_V15.md) for the current packed tree
...
[Small snowbank crushing](../gameplay/SNOW_CRUSHING.md) adds temporary, non-rebounding
