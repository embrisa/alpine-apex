...
actual loading screens. See [live menu camera](CAMERA.md#live-menu-camera).
...
uses a private loop of the user-supplied [Forest wind 01](WIND_AUDIO.md) recording
...
- Final forest-audio review: **15/15** native checks passed, including master
  preservation, loop wrapping and playback lifecycle; see [wind evidence](WIND_AUDIO.md#validation--2026-09-08).
