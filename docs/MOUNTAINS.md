...
Mineral foundations follow the [geology contract](GEOLOGY_V11.md).
...
physics settings. See [wilderness rules](WILDERNESS.md) and [snow traction](PLANTED_SNOW.md).
...
See [GENERATION_V15.md](GENERATION_V15.md) for implementation, measurements and
validation, and [WINDOWS_PLAYTEST.md](WINDOWS_PLAYTEST.md) for export manifests
