...
[animation ownership](../presentation/SKIER_ANIMATION.md) and [anatomical constraints](../presentation/SKIER_ANATOMY.md).
...
the [current v13 setup](../world/ALPINE_V13.md#fast-test-setup) for full-mountain acceptance;
