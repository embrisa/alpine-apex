...
|---|---|---|
| Default mountain | Seed 849205174, generator 17, Standard | [startup](../scripts/main.gd), [definition](../scripts/world/mountain_definition.gd), [settings](../scripts/world/generation_settings.gd) |
...
| `world/mountain_cache_v17.gd`, `mountain_preparation.gd` | Validated physical/scenery preparation; main thread owns publication and GPU submission |
