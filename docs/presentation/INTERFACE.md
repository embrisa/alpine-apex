...
See [camera behavior and validation](../gameplay/CAMERA.md#live-menu-camera).
...
See [camera behavior and controls](../gameplay/CAMERA.md) and the
[camera profiles and preview validation](../gameplay/CAMERA_V2_VALIDATION.md).
