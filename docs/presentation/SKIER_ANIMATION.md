...
[ski attachment](../gameplay/SKIER_PHYSICS.md#ski-attachment-and-render-timing).
...
[validation](../development/VALIDATION.md) for current acceptance and output lifecycle.
