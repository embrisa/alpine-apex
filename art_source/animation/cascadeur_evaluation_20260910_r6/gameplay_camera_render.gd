...
func run():
	...
	var metadata={"pixels":[1600,900],"scope":"Recorded production ChaseCamera at 30 FPS on deterministic solver plane. No mountain/scenery or performance claim.","renderer_sha256":FileAccess.get_sha256("res://art_source/animation/cascadeur_evaluation_20260910_r6/gameplay_camera_render.gd"),"scenarios":{}}
