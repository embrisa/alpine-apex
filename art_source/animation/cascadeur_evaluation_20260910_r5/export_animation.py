...
assert scene_path.name == 'ready_compression_r5.casc', scene_path
assert scene_path.parent.name in {
    'cascadeur_evaluation_20260910_r5', 'cascadeur_rig_20260910_r5'
}, scene_path
...
output = scene_path.with_name('ready_compression_r5_reexport.glb')
