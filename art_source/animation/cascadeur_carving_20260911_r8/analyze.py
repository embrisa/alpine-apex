...
report={'scope':'726 matched input times in two simulations on 22 cm snow. R7 hands in both; R8 pressure support changes physics. Geometry and user preference are separate.','scenarios':{}}
for case in read(base/'cascadeur-20260911-r8-01-after/capture/manifest.json')['scenarios']:
    name=case['name'];a=read(base/'cascadeur-20260911-r8-01-before/capture'/f'{name}.json');b=read(base/'cascadeur-20260911-r8-01-after/capture'/f'{name}.json')
