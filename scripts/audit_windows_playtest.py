...
with (build / "AlpineApex.pck").open("rb") as stream:
    ...
    required = ["main.tscn.remap", "scripts/world/mountain_cache_v15.gd", "config/generation_dependencies.json", "scripts/core/ski_simulation.gd", "assets/graphics/geology_v11/catalog.json"]
...
assert (build / "data/default_mountain_v15.physical").is_file()
assert (build / "data/default_mountain_v15.scenery").is_file()
