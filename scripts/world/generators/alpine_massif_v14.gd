...
## V14: localized rounded snow formations over the v13 massif and ecology.
## One immutable support grid. Generation has
## no Nodes, rider state, rendering quality, or preferred player racing line.
const Face = preload("res://scripts/world/generators/alpine_face_v14.gd")
const TreeSnow = preload("res://scripts/world/generators/tree_snow_v14.gd")
