...
const DIRECTORY = "user://mountain_bake_cache_v12"
static func generate(seed_value: int):
	var begin = Time.get_ticks_usec()
	var key = "%d|%s" % [seed_value,Engine.get_version_info().string]
	for path in ["res://scripts/world/generators/alpine_massif_v12.gd","res://scripts/world/generators/alpine_face_v12.gd","res://scripts/world/heightfield_surface.gd","res://scripts/world/mountain_geology_v12.gd","res://scripts/world/mineral_catalog.gd","res://scripts/world/mineral_catalog_data.gd","res://scripts/world/mineral_collision.gd","res://assets/graphics/geology_v11/catalog.json","res://assets/graphics/geology_v11/catalog.res"]:
