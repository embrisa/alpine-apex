...
static func _decode_into(prepared, field, quality, job, archive_path: String = "") -> bool:
	...
	var bundled_path = OS.get_executable_path().get_base_dir().path_join("data/default_mountain_v17.scenery")
	...
	prepared.mountain.physics_authority = "alpine-drainage-v17"
