...
def main():
    ...
    for name, pair in pairs.items():
        ...
        draw.text((24, 54), "BEFORE · Original snow bump", font=font(22), fill="#b8c8d7")
...
<div class="labels"><span>Before · Original bump</span><span>After · Half bump</span></div>
<div class="comparison" style="--split:50%"><img src="{name}_after.png" alt="Half snow bump">
<div class="before"><img src="{name}_before.png" alt="Original snow bump"></div><div class="line"></div>
...
<details><summary>Compare the same close-up</summary><div class="crop"><figure><img src="{name}_before_crop.png"><figcaption>Before · Original bump</figcaption></figure><figure><img src="{name}_after_crop.png"><figcaption>After · Half bump</figcaption></figure></div></details>
...
<p>Drag across each image to compare. <strong>Before</strong> uses the original snow texture bump contribution; <strong>after</strong> halves it. Each pair has the same camera, weather, lighting, terrain and frozen particles. Color, roughness, sparkle settings and geometry are unchanged. Half-strength snow bump is now the adopted default.</p>
