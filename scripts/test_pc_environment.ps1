param([string]$OutputDirectory = 'artifacts/pc_environment/regression', [string[]]$Suites = @('physics_suite','runtime_suite','graphics_suite','pc_graphics_suite','golden_sunlight_suite','mountain_suite','generated_mountain_suite','mountain_library_suite','summit_mountain_suite','technical_showcase_suite','technical_showcase_hazards','technical_showcase_v6_suite','technical_showcase_v6_hazards','technical_showcase_v7_suite','technical_showcase_v7_hazards','technical_showcase_v8_suite','technical_showcase_v8_hazards','powder_volume_suite','massif_v10_suite','massif_contract_suite','race_suite','competitive_suite'))
