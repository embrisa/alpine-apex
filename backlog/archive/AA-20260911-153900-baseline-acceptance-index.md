...
The imported [roadmap](../../docs/VALIDATION.md#race-and-player-acceptance) and [documentation index](../../docs/ARCHITECTURE.md#current-identity) still describe default mountain v14 and race schema 3. During backlog setup, [project guidance](../../AGENTS.md) and [validation](../../docs/VALIDATION.md#check-selection) use v15; live ski simulation declares model 28 and race_definition.gd declares schema 4. These are inspection findings from 2026-09-11, not permanent version assumptions. Verify them again.

## Agreed decisions and scope

This is a documentation-only reconciliation of existing work. Update docs/ARCHITECTURE.md, docs/VALIDATION.md and docs/VALIDATION.md as needed; link maintained subsystem evidence instead of duplicating reports. Preserve player acceptance as open wherever it remains unverified. Do not change game behavior or claim fresh performance measurements.
...
[current acceptance checklist](../../docs/VALIDATION.md#race-and-player-acceptance)
