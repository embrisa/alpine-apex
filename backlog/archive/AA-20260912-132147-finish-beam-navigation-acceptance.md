...
Originating tasks: [AA-20260911-232811-taller-distant-finish-beam](../tasks/AA-20260911-232811-taller-distant-finish-beam.md), [AA-20260911-232936-session-navigation-beams](../tasks/AA-20260911-232936-session-navigation-beams.md). Evidence: `artifacts/orchestration_20260912/navigation/landmark-preflight-parent-v4/`, `finish/nav500/`, `amber_and_air/finish_500m.log`, and `navigation/landmark_v4/`. Measurements are from2026-09-12; private proposals and frozen captures are local, ignored evidence, not shipped dependencies. Recheck live source before applying a candidate.
