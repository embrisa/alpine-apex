...
- Related work: [pole pushing](../blocked/AA-20260911-183812-slope-limited-pole-pushing.md) and [animated ghosts](../blocked/AA-20260911-220556-animated-ghost-snow-tracks.md). Inspect their completed sources before fixing a baseline. This task does not author different motions or reopen the abandoned animator editor.
...
is scoped in the [new focused task](AA-20260913-141128-reduce-pelvis-fitting-cpu-cost.md).
