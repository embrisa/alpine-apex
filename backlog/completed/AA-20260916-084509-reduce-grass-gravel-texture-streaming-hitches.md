...
- Forest region publication, terrain trimesh cooking and tree/mineral
  ...
  [the forest publication and collision task](../tasks/AA-20260913-141128-reduce-forest-publication-and-collision-bursts.md);
  mineral convex warming was delivered by
  [the archived streaming task](AA-20260912-105300-reduce-streaming-frame-spikes.md).
