...
Imported on 2026-09-11 under the user's authorization to review existing unfinished
work. Current-source inspection found v15 startup/cache guidance, physics model 28
and race schema 4; entry-point documentation still carries some older identities.
The first documentation task resolves those against live code again.
...
or rewriting a subsystem. Workers may propose follow-ups in
[ideas](ideas/README.md); only the user selects ideas for task authoring.

Imported work is prioritized according to project guidance. Dependency links make
the baseline documentation the first ready task; blocked human acceptance is not
a reason to fabricate automated approval or repeatedly launch an agent.
