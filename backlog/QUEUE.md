...
- **[Wind-packed and scoured snow](tasks/AA-20260918-011206-show-wind-packed-and-scoured-snow.md)** (in progress): existing wind-mask response strengthened and measured; user variety/readability gate remains.
- **[Wind-drift lee shading](tasks/AA-20260918-011207-shade-wind-drift-lee-sides.md)** (in progress): height-derived secondary tint/AO implemented and measured; first-person contrast improved, chase Auto nearly unchanged; user look gate remains.
...
- **[Sun shadow penumbra](completed/AA-20260918-011210-soften-sun-shadow-edges-with-distance.md)** (P3, done): restrained sun/moon penumbra from High upward; lower presets retain PCF. Native contact/motion review and per-preset costs recorded.
...
- **[Sky-lit shaded snow](tasks/AA-20260918-092101-light-shaded-snow-from-the-actual-sky.md)** (in progress): normal-driven current-sky ambient implemented and measured; user colour gate remains.
