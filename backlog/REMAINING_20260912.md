...
The existing implementation is checkpointed at the user's request. Seven ready tasks own the remaining work; original tasks are blocked rather than falsely marked complete. Dependencies serialize the required fixes. No agents or tests are launched by authoring.
...
- [Finish shared beam and navigation acceptance](tasks/AA-20260912-132147-finish-beam-navigation-acceptance.md)
...
- [Resolve pronounced loaded snow-track ridge shapes](tasks/AA-20260912-132147-review-loaded-track-ridge-shape.md)
