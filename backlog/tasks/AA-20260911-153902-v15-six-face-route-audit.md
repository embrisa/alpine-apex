...
[Validation](../../docs/VALIDATION.md#check-selection) still carries forward a v13 pilot completing one face while crashing or stalling on others. Existing tests/alpine_v13_route_survey.gd and tests/alpine_v14_routes.gd target historical identities; they do not establish current v15 coverage.
...
- [ ] Update docs/WORLD.md and the route acceptance summary with the result.
