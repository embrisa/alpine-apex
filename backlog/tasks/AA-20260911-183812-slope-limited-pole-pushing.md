...
- The earlier [Cascadeur evaluation handoff](../../docs/tasks/CASCADEUR_WORKFLOW_AND_GAMEPLAY_EVALUATION.md)
  ...
  [review lessons](../../docs/ANIMATION_REVIEW_LESSONS.md) document how downstream
...
1. Read [architecture](../../docs/ARCHITECTURE.md),
   [competition boundaries](../../docs/ONLINE_COMPETITION.md), and the
...
7. Document the final curve (degrees and km/h), force/cadence, action ownership,
   ...
   documentation. Follow the [engine strategy](../../docs/ENGINE_STRATEGY.md)
...
- [ ] Render and inspect complete chronological plant/push/recovery cycles and
  ...
  [pose-review workflow](../../docs/ANIMATION_AGENT_WORKFLOW.md), fresh frozen
