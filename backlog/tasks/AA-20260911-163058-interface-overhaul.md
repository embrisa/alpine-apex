...
tests and `docs/INTERFACE.md` had concurrent working edits; these subsequently
...
- [Theme](../../scripts/ui/alpine_theme.gd) and
  ...
  [Interface documentation](../../docs/INTERFACE.md) describes earlier rendered
...
[graphics policy](../../docs/GRAPHICS.md), [FidelityFX](../../docs/FIDELITYFX.md)
and [input/competition boundaries](../../docs/ONLINE_COMPETITION.md). No change
...
0.0000003032 m. See [animation workflow evidence](../../docs/ANIMATION_AGENT_WORKFLOW.md#source-pose-diagnostics),
